...
//limpa as variaveis quando o modal for fechado
watch(open, (value) => {
  if (!value) {
    state.title = ''
...
<template>
  <UModal v-model:open="open" title="New publication" description="Add a new publication to the database">
    <UButton label="New publication" icon="i-lucide-plus" />
